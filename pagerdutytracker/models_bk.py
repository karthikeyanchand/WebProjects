...
class Payload(models.Model):
    ...
    component       = models.CharField(max_length=100, verbose_name="Component", null=False, blank=False)
    group           = models.CharField(max_length=100, verbose_name="Group", null=False, blank=False)
    custom_details  = models.TextField(max_length=2500, verbose_name="CustomDetails")
    class_name      = models.CharField(max_length=500, verbose_name="Class")
